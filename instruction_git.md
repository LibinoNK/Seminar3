...
Для того, чтобы загрузить изменения из удаленного репозитория, Вам нужно хорошенько этого захотеть и написать об этом в письме Деду Морозу или Санте (в зависимости от того, в кого Вы верите)! С новым годом!
